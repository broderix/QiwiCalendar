...
//844055464387-qttrcl5ol0m3sei41dmqtjsregbud6on.apps.googleusercontent.com
// JZ2hhtk72h913RGxFX5SDtDF
...
app.get('/googleAuth', function(req, res) {
  fs.readFile('client_secret.json', function processClientSecrets(err, content) {
    ...
    authorizeWeb(JSON.parse(content), function(authUrl) {
...
function authorizeWeb(credentials, callback) {
